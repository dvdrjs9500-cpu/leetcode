...
| 5 | Longest Palindromic Substring | Find the longest palindromic substring in a string |
...
| 19 | Remove Nth Node From End of List | Remove the nth node from the end of a linked list and return its head |
| 20 | Valid Parentheses | Determine if an input string containing brackets is valid |
| 21 | Merge Two Sorted Lists | Merge two sorted linked lists into one sorted list |
| 22 | Generate Parentheses | Generate all combinations of well-formed parentheses for n pairs |
| 23 | Merge k Sorted Lists | Merge k sorted linked lists into one sorted linked list |
| 24 | Swap Nodes in Pairs | Swap every two adjacent nodes in a linked list |
| 25 | Reverse Nodes in k-Group | Reverse nodes of a linked list k at a time |
...
| 70 | Climbing Stairs | Find the number of distinct ways to climb to the top taking 1 or 2 steps |
